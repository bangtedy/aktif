...
fig-caption: yes
link-citations: yes
github-repo: https://github.com/bangtedy/akuanti
...
url:  "https://bangtedy.github.io/akuanti"
...
::: {.rmdnote}
**Note**: This book is a work in progress. If you have any feedback, please feel free to [file an issue on GitHub](https://github.com/bangtedy/akuanti/issues). Thank you!
:::
```
...
Matakuliah ini akan membahas dan mempresentasikan konsep-konsep dan prinsip-prinsip statistika sebagai alat investigasi kuantitatif yang dilengkapi dengan grafik dan verbal yang intuitif untuk pengambilan keputusan bisnis. Matakuliah ini berfokus pada alat-alat/metode-metode yang dapat diterapkan (khususnya regresi) untuk pengambilan keputusan bisnis dan mengembangkan keterampilan penggunaan program komputer R. 

Materi yang akan dibahas meliputi: statistik dan analitik bisnis, visualisasi data dengan grafik dan chart, statistika deskriptif, peluang, Distribusi diskret dan kontinyu, Distribusi Uniform dan Distribusi Normal, distribusi Sampling, estimasi parameter, uji hipotesis, korelasi, regresi sederhana, regresi berganda, uji asumsi klasik, GLM.
...
Mahasiswa mampu menjelaskan dan mempresentasikan konsep-konsep statistika sebagai alat investigasi kuantitatif yang dilengkapi dengan grafik dan verbal yang intuitif untuk pengambilan keputusan bisnis serta memiliki keterampilan keterampilan penggunaan program komputer R. 
